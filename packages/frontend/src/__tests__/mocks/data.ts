...
export const mockEvents = [
  ...
  },
  {
    ...
    description: null,
    eventType: 'party',
    scheduledAt: '2024-09-10T10:00:00.000Z',
    occurredAt: null,
    isCompleted: false,
    variables: {},
...
export const mockEncounters = [
  ...
  },
  {
    ...
    description: null,
    difficulty: 3,
    scheduledAt: '2024-08-10T10:00:00.000Z',
    isResolved: false,
    resolvedAt: null,
    variables: {},
    createdAt: '2024-01-03T00:00:00.000Z',
  ...
  },
  {
    ...
    description: null,
    difficulty: 5,
    scheduledAt: '2024-09-01T12:00:00.000Z',
    isResolved: false,
    resolvedAt: null,
    variables: {},
    createdAt: '2024-01-04T00:00:00.000Z',
...
export const mockConditions = [
  ...
  },
  {
    id: 'condition-5',
    entityType: 'Settlement',
    entityId: null, // Type-level condition applies to all settlements
    field: 'is_capital',
    expression: { '==': [{ var: 'is_capital' }, true] },
    description: 'Applies to capital settlements',
    isActive: true,
    priority: 15,
    version: 1,
    createdAt: '2024-01-01T00:00:00.000Z',
...
export const mockEffects = [
  ...
  },
  {
    ...
    description: 'Alerts nearby settlements before encounter begins',
    effectType: 'patch',
    payload: [
      {
        op: 'add',
