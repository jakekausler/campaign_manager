...
export const mockConditions = [
  {
    ...
    description: 'Settlement is a trade hub if level is 3 or higher',
    isActive: true,
    priority: 10,
    version: 1,
    createdAt: '2024-01-01T00:00:00.000Z',
  ...
  },
  {
    ...
    description: 'Settlement is fortified if defense is 30 or higher',
    isActive: true,
    priority: 20,
    version: 1,
    createdAt: '2024-01-01T00:00:00.000Z',
  ...
  },
  {
    ...
    description: 'Structure is operational if level is 1 or higher',
    isActive: true,
    priority: 5,
    version: 1,
    createdAt: '2024-01-01T00:00:00.000Z',
  ...
  },
  {
    ...
    field: 'has_population',
    expression: { '>': [{ var: 'population' }, 0] },
    description: 'Type-level condition: settlement has population',
    isActive: true,
    priority: 1,
    version: 1,
    createdAt: '2024-01-01T00:00:00.000Z',
