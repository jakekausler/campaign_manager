...
/**
 * SettlementPanel displays Settlement-specific information.
 *
 * Features:
...
export function SettlementPanel({ settlement }: SettlementPanelProps) {
  ...
  const variables = settlement.variables || {};
    ...
    <div className="space-y-6">
      ...
      <Card className="p-4">
        ...
        {hasVariables ? (
          ...
          <p className="text-sm text-slate-500">No typed variables available for this settlement</p>
        )}
      </Card>
    </div>
  );
