 ...
 *
 * Adapted from packages/api/src/graphql/services/dependency-graph-builder.service.ts
 * for the rules engine worker.
 */
 ...
 */
@Injectable()
export class DependencyGraphBuilderService implements OnModuleDestroy {
  ...
  constructor() {
    ...
    // Note: In a future refactor, this should be injected via DI
  ...
  /**
   * Cleanup Prisma connection on module destroy
   */
